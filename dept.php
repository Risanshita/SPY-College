     ...
     <li style="width:150px;">
	  ABOUT US
		   <ul>
			  ...
			  <li><a href="sec.php">SECRETRY</a></li>
                <li><a href="mis.php">OUR MISSION</a></li>
			  <li><a href="out.php">OUR VISION</a></li>
			 </ul>
             </li>
...
<div class="ia" style="box-shadow:10px 10px 10px #666666; width:350px;"><h3 > DEPARTMENT OF EXAMINATION </h3>
</div>

<br />
<h4 style="float:left; text-align:justify; text-justify:inter-word;">
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;The department of  examination of this college is situated on the ground floor beside the general section . The all examination works are conducted from this office by the controller of examination along with deployed functionaries under the headship of centre superintendent.
	The main function of this department is to conduct the Internal Annual examination, sent-up test, Board examinations and university examinations. Apart from this,other many competitive examinations are also conducted time to time.
	The department of examination remains always alert to conduct fair & smooth examination.
	This office always provides the update informations regarding various examinations on its website and through notice board.
    </h4>
    <br />
...
<img src="img/gal1.JPG" height="440" width="1000"/>
<br />
<h3 style="font-family:'Palatino Linotype', 'Book Antiqua', Palatino, serif;">
A view of Department of Examination<br />
Controller of Examination :- Dr. Shiw Pujan Prasad <br />

<br />
<center><img src="img/fun.jpg" height="450" width="1000"/></center>
<b>A   meeting view  of  the functionaries of   Examination  Deptt..</b>
