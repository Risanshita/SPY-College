...
<h3 style="font-family:'Palatino Linotype', 'Book Antiqua', Palatino, serif;color:#00000; text-shadow:10px 10px  20px #666666; color:white;"> 
     <div class="mis" style="box-shadow:10px 10px 10px #666666;">LABS
     </div></h3>
...
<center><img src="img/clab.jpg" /></center>
<center> A view of lab of Department of Chemistry  </center>
<br />

This is one of the unique  lab in any  college in the satate having live  update equipments viz,. and a big chemical lab for students and Cellular Mobile Base Station, three sectors antenna, mini-microwave link, state of art SMPs Smart Power meter and solar panel. This lab also has working model of cell site with passive infrastructure viz; BTS Shelter, External BTS, Gen set, solar panel and tower etc. Lab also has anti-static flooring required for cell site.
<br />
<center><img src="img/lab.jpg"  width="800"/></center>
<center> A view of lab of Department of Botony</center>
<br/>

Leading telecom networks/service providers have contributed all the equipments for this unique lab. Industry is also supporting the institution in imparting training as & when required by the faculty & students
<br />
<center><img src="pr.jpg"  width="800"/></center>
<center> A view of lab of Department of Physics</center>

<br />

<center><img src="img/cmlab.PNG" height="400" width="700"  />

<center>A VIEW OF COMPUTER LAB</center>


<br />
<br /></center>
The amphitheater style classrooms provide the most conducive atmosphere for dynamic and focused discussions. They have been designed to bring together analysis with action and are augmented by well-equipped facilities.
