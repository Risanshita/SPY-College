...
background: black url(http://spycollege.org/ajaxload.gif) center center no-repeat; /* loading gif while caoursel is loading */
}
...
<body>
<div class="con">
 <img src="http://spycollege.org/img/phone.PNG" height="30" width="30" style="float-right:-20px; "><!--h3 style="font-family:'Lucida Sans Unicode', 'Lucida Grande', sans-serif;"--> <b>0631-2221574<br /><a href="https://www.facebook.com/spycollegegaya/?ref=hl" target="_blank"><img src="http://spycollege.org/img/fb.jpg"
...
<div class="menu">
<center><div class="h2"><img src="http://spycollege.org/img/g-icon.png" style="float:right; margin-top:8px; margin-right:-30px;"/><img src="http://spycollege.org/img/f-icon.png" style="float:right; margin-top:8px;" /><img src="http://spycollege.org/img/t-icon.png" style="float:right; margin-top:8px;  "/>
 <h3> <ul>
     <li style="width:auto;">
...
<!--------------------------cource in notice------------------------------------------------->
<div class="h6" style="float:right;"><div class="h7" style="box-shadow:10px 10px 10px #000;"><font size="+2" style="text-shadow:1px 1px 2px Yellow,0px 0px 12px magenta,0px 0px 10px green;margin-top:0px; color:#FFF;   "> <center>COURSES</center></font>
</div><font size="3">
                        <p><a href="http://spycollege.org/ug.php" style="text-decoration:none; color:black;">UNDER GRADUATE(ALL STREAM)<img  src="http://spycollege.org/img/new-blink.gif"  /></p></a>
						
						
						
<p><a href="http://spycollege.org/isc.php" style="text-decoration:none; color:black;">INTERMEDIATE OF SCIENCE
<img  src="http://spycollege.org/img/clickh.gif" /></P></font></a>
...
<img  src="http://spycollege.org/img/clickh.gif" /></P></font></a>
<a href="http://spycollege.org/dept.php" style="text-decoration:none;"><div class="dept"> <font size="+2" style="text-shadow:1px 1px 2px Yellow,0px 0px 12px magenta,0px 0px 10px green;margin-top:0px; color:#FFF;   "> <center>DEPTT. OF EXAMINATION<!--img src="http://spycollege.org/img/click.PNG" height="25" width="80"--></center></font></div></a>
</div>
...
<a href="http://spycollege.org/lb.php" style="text-decoration:none; color:#666;">LABS</a></div>
...
<a href="https://www.google.co.in/maps/place/Surendra+Prasad+Yadav+College/@24.7859554,84.9803732,1446m/data=!3m1!1e3!4m5!1m2!2m1!1sspy+college+gaya!3m1!1s0x0000000000000000:0xb6a0112c52bc7f99!6m1!1e1?hl=en" target="_blank"><img src="http://spycollege.org/img/map.PNG" height="200" width="250" /></a></div></b>
...
<h3> Labs<BR /><br>
 ...
 <img src="http://spycollege.org/img/Cn.PNG" height="80" width="280" />
  <a href="mailto:info@spycollege.org"> <img src="http://spycollege.org/img/mail_logo.PNG" height="160" /></a><p>
 ...
 <div class="ft"> <b style="color:#999; text-align:center;"><br /><center>Spy College @2015-16 All Right Reserved</center></b><b style="float:right; color:#999; margin-top:-30px;"><a href="https://www.facebook.com/jshavant.verma" style="text-decoration:none;color:#FFF;">Developed BY-Jaswant singh &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
