...
Practical works are an integral part of the syllabus for all science subjects. For this laboratories are the distinguishing feature where students come and learn practically.
To provide first hand knowledge to the students our college has well equipped laboratories of Physics, Chemistry, Botany, Zoology, Computer Science, Geography, Psychology and Home Science. The laboratories have  modern equipments and apparatus.   The amphitheater style-labs provide the most conducive atmosphere for dynamic and focused discussions. They have been designed to bring together analysis with action and are augmented by well-equipped facilities.The new practical means are provided time to time as per requirements so that the practical classes of the students be continue smoothly under the   guidance of  Lab-technicians and teachers.
