...
<h3 style="font-family:'Palatino Linotype', 'Book Antiqua', Palatino, serif;color:#00000; text-shadow:10px 10px  20px #666666; color:white;"> 
     <div class="mis" style="box-shadow:10px 10px 10px #666666;">GREAT MISSION
     </div></h3>
...
	To provide affordable and quality based education to every sections of society.
	To maintain fair and peaceful academic  environment inside the campus without feeling of castes, creeds, genders & religions.
	To maintain the duties & responsibilities among the administration, faculties, staffs and students.
	To develop better academic needments & extracurricular means.
	To instill in students the love, the ways and the habit of learning through seminars,  debates & other cultural activities.
	To improve the mental and moral power of the students for the benefit of 
	society.
	To encourage students to face the competencies for success.
	To launch the new technical and non technical courses.
...
<br />
<br /></center>
Finally the mission of college is therefore to assist the students to bring forth the maturity and wisdom, self knowledge, intellectual honesty, clarity of thoughts, depth of knowledge, an independent capacity, mental courage, self discipline & tolerance to prepare as successful citizen.<!--div class="sig_pr" style="color:#000;"><center>Principal<br />Dr.Umashankar</center></div-->
<!--div class="mail_pic">
